...
public class IgPublisherSettingsEditor extends SettingsEditor<IgPublisherConfiguration> {
    ...
    private static final Color GREEN = new JBColor(new Color(77, 187, 79), new Color(77, 187, 79));
    private static final Color RED = new JBColor(new Color(77, 187, 79), new Color(77, 187, 79));
