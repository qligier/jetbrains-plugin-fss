...
/**
 * PSI model for an FSH Profile item.
 *
 * @author Quentin Ligier
 **/
public class FshProfileItem extends FshItem {
    public FshProfileItem(final @NotNull ASTNode node) {
        super(node);
    }
    ...
    public @NotNull String getFoldedPlaceholder() {
        return "Profile: " + this.getSafeName();
    }
}
