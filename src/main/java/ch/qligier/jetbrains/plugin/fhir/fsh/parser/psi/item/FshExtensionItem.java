...
/**
 * PSI model for an FSH Extension item.
 *
 * @author Quentin Ligier
 **/
public class FshExtensionItem extends FshItem {
    public FshExtensionItem(final @NotNull ASTNode node) {
        super(node);
    }
    ...
    public @NotNull String getFoldedPlaceholder() {
        return "Extension: " + this.getSafeName();
    }
}
