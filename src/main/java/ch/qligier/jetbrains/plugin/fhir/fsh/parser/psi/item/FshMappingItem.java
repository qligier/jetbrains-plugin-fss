...
/**
 * PSI model for an FSH Mapping item.
 *
 * @author Quentin Ligier
 **/
public class FshMappingItem extends FshItem {
    public FshMappingItem(final @NotNull ASTNode node) {
        super(node);
    }
    ...
    public @NotNull String getFoldedPlaceholder() {
        return "Mapping: " + this.getSafeName();
    }
}
