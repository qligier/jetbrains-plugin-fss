...
public class FshPairedBraceMatcher implements PairedBraceMatcher {
    ...
    private static final BracePair[] PAIRS = new BracePair[]{
            new BracePair(FshTokenTypes.getTokenElementType(FshParser.LEFT_PAREN),
                          FshTokenTypes.getTokenElementType(FshParser.RIGHT_PAREN),
                          false),
            new BracePair(FshTokenTypes.getTokenElementType(FshParser.LEFT_BRACKET),
                          FshTokenTypes.getTokenElementType(FshParser.RIGHT_BRACKET),
                          false),
    };
