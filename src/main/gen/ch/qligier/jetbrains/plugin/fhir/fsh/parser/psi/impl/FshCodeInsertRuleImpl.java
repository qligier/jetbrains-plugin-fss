...
public class FshCodeInsertRuleImpl extends ASTWrapperPsiElement implements FshCodeInsertRule {

  public FshCodeInsertRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitCodeInsertRule(this);
  }
