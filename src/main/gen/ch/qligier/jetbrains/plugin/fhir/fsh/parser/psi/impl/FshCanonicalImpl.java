...
public class FshCanonicalImpl extends ASTWrapperPsiElement implements FshCanonical {

  public FshCanonicalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitCanonical(this);
  }
