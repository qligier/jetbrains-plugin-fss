...
public class FshVsFromValuesetImpl extends ASTWrapperPsiElement implements FshVsFromValueset {

  public FshVsFromValuesetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitVsFromValueset(this);
  }
