...
public class FshMappingMetadataImpl extends ASTWrapperPsiElement implements FshMappingMetadata {

  public FshMappingMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitMappingMetadata(this);
  }
