...
public class FshValueSetRuleImpl extends ASTWrapperPsiElement implements FshValueSetRule {

  public FshValueSetRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitValueSetRule(this);
  }
  ...
  @Override
  @Nullable
  public FshStrength getStrength() {
    return findChildByClass(FshStrength.class);
  }
