...
public class FshMixinsMetadataImpl extends ASTWrapperPsiElement implements FshMixinsMetadata {

  public FshMixinsMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitMixinsMetadata(this);
  }
