...
public class FshSeverityMetadataImpl extends ASTWrapperPsiElement implements FshSeverityMetadata {

  public FshSeverityMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitSeverityMetadata(this);
  }
