...
public class FshNameTokenImpl extends ASTWrapperPsiElement implements FshNameToken {

  public FshNameTokenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitNameToken(this);
  }
