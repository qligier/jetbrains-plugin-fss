...
public class FshParentMetadataImpl extends ASTWrapperPsiElement implements FshParentMetadata {

  public FshParentMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitParentMetadata(this);
  }
