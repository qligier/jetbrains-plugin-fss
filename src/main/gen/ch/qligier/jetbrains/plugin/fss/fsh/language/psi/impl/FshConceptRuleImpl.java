...
public class FshConceptRuleImpl extends ASTWrapperPsiElement implements FshConceptRule {

  public FshConceptRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitConceptRule(this);
  }
  ...
  public PsiElement getCode() {
    return findNotNullChildByType(CODE);
  }

  @Override
  public @Nullable PsiElement getDefinition() {
    return FshPsiImplUtil.getDefinition(this);
  }
