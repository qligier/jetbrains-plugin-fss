...
public class FshTargetMetadataImpl extends ASTWrapperPsiElement implements FshTargetMetadata {

  public FshTargetMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitTargetMetadata(this);
  }
