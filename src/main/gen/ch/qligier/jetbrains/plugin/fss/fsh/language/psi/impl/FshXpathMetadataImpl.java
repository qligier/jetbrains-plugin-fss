...
public class FshXpathMetadataImpl extends ASTWrapperPsiElement implements FshXpathMetadata {

  public FshXpathMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitXpathMetadata(this);
  }
