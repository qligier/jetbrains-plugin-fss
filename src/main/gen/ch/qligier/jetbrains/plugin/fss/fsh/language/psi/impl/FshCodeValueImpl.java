...
public class FshCodeValueImpl extends ASTWrapperPsiElement implements FshCodeValue {

  public FshCodeValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitCodeValue(this);
  }
