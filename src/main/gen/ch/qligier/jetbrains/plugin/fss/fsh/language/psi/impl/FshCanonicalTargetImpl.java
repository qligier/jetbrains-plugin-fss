...
public class FshCanonicalTargetImpl extends ASTWrapperPsiElement implements FshCanonicalTarget {

  public FshCanonicalTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitCanonicalTarget(this);
  }
