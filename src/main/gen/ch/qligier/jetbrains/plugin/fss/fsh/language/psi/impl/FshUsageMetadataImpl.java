...
public class FshUsageMetadataImpl extends ASTWrapperPsiElement implements FshUsageMetadata {

  public FshUsageMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitUsageMetadata(this);
  }
