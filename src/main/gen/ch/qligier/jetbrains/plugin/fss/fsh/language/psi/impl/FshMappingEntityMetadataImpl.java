...
public class FshMappingEntityMetadataImpl extends ASTWrapperPsiElement implements FshMappingEntityMetadata {

  public FshMappingEntityMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitMappingEntityMetadata(this);
  }
  ...
  @Override
  @Nullable
  public FshSourceMetadata getSourceMetadata() {
    return findChildByClass(FshSourceMetadata.class);
  }

  @Override
  @Nullable
  public FshTargetMetadata getTargetMetadata() {
    return findChildByClass(FshTargetMetadata.class);
  }
