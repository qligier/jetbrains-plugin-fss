...
public class FshVsFromSystemImpl extends ASTWrapperPsiElement implements FshVsFromSystem {

  public FshVsFromSystemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitVsFromSystem(this);
  }
