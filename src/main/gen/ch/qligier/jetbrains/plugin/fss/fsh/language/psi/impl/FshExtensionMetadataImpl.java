...
public class FshExtensionMetadataImpl extends ASTWrapperPsiElement implements FshExtensionMetadata {

  public FshExtensionMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitExtensionMetadata(this);
  }
  ...
  @Override
  @Nullable
  public FshContextMetadata getContextMetadata() {
    return findChildByClass(FshContextMetadata.class);
  }
