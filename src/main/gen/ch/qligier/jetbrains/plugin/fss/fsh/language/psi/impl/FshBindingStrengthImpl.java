...
public class FshBindingStrengthImpl extends ASTWrapperPsiElement implements FshBindingStrength {

  public FshBindingStrengthImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitBindingStrength(this);
  }
