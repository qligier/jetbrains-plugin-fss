...
public class FshRatioValueImpl extends ASTWrapperPsiElement implements FshRatioValue {

  public FshRatioValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitRatioValue(this);
  }
