...
public class FshRuleSetParamImpl extends ASTWrapperPsiElement implements FshRuleSetParam {

  public FshRuleSetParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitRuleSetParam(this);
  }
