...
public class FshVsMetadataImpl extends ASTWrapperPsiElement implements FshVsMetadata {

  public FshVsMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitVsMetadata(this);
  }
