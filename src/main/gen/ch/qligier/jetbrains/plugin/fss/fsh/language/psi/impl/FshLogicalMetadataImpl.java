...
public class FshLogicalMetadataImpl extends ASTWrapperPsiElement implements FshLogicalMetadata {

  public FshLogicalMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitLogicalMetadata(this);
  }
  ...
  @Override
  @Nullable
  public FshCharacteristicsMetadata getCharacteristicsMetadata() {
    return findChildByClass(FshCharacteristicsMetadata.class);
  }
