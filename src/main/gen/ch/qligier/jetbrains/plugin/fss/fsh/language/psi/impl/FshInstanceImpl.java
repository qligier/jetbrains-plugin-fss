...
public class FshInstanceImpl extends FshNamedElementImpl implements FshInstance {
  ...
  @Override
  @NotNull
  public List<FshInstanceMetadata> getInstanceMetadataList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FshInstanceMetadata.class);
  }
  ...
  @Override
  public @NotNull List<@NotNull FshInstanceMetadata> getMetadata() {
    return FshPsiImplUtil.getMetadata(this);
  }

  @Override
  public @NotNull List<@NotNull FshInstanceRule> getRules() {
