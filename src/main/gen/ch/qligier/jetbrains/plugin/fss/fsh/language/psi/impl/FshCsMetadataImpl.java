...
public class FshCsMetadataImpl extends ASTWrapperPsiElement implements FshCsMetadata {

  public FshCsMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitCsMetadata(this);
  }
