...
public class FshSourceMetadataImpl extends ASTWrapperPsiElement implements FshSourceMetadata {

  public FshSourceMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitSourceMetadata(this);
  }
