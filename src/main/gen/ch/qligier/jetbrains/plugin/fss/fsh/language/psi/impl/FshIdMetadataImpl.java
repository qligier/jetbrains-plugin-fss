...
public class FshIdMetadataImpl extends ASTWrapperPsiElement implements FshIdMetadata {

  public FshIdMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FshVisitor visitor) {
    visitor.visitIdMetadata(this);
  }
